...
Follow these steps to go from signup to your first dashboard in Northstar Analytics.

## Create your workspace

1. Sign up at app.northstar-analytics.example
...
Add the Northstar snippet to your site `<head>`:

```html
<script>
  (function(n,o){/* Northstar loader stub for demo docs */})(window, document);
  northstar.init('YOUR_WRITE_KEY');
</script>
```
...
Pro trial users can use chat support. Free plan: email support@northstar-analytics.example with subject “Onboarding help” and your workspace ID.
